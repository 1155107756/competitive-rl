...
if __name__ == "__main__":
    ...
    agent_to_train.load_param('param/car0.4.pkl')
    ...
    for i_ep in range(100000):
        ...
        for t in range(1000):
            ...
            action2,  a_logp_2= agent_to_train.select_action(states[1])
            ...
            if agent_to_train.store((states[1], action2, a_logp_2, rewards[1], states_[1])):
        ...
        running_score_2 = running_score_2 * 0.99 + score_2 * 0.01
        if i_ep % args.log_interval == 0:
            #if args.vis:
            draw_reward(xdata=i_ep, ydata=running_score,name="1")
            print('Ep {}\tLast score: {:.2f}\tMoving average score: {:.2f}'.format(i_ep, score, running_score))
            draw_reward(xdata=i_ep, ydata=running_score_2,name="2")
            print('Ep {}\tLast score: {:.2f}\tMoving average score: {:.2f}'.format(i_ep, score_2, running_score_2))
            agent_to_train.save_param('param/car0.4.pkl')
